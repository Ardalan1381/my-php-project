        ...
        <main class="flex-1 p-4 md:p-8 pt-20">
            <div class="card p-6">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-xl font-semibold text-white"><i class="fas fa-hospital mr-2 text-blue-400"></i> مدیریت بیمارستان‌ها</h2>
                    <a href="/site/admin/add_hospital.php" class="btn-action text-green-300 hover:text-green-100"><i class="fas fa-plus mr-1"></i> افزودن بیمارستان</a>
                </div>
                        ...
                        <tbody>
                            <?php foreach ($hospitals as $hospital): ?>
                                <tr>
                                    ...
                                    <td><?php echo number_format($hospital['room_price'], 2); ?></td>
                                    <td>
                                        <a href="/site/admin/edit_hospital.php?id=<?php echo $hospital['hospital_id']; ?>" class="btn-action text-yellow-300 hover:text-yellow-100 mr-2"><i class="fas fa-edit"></i></a>
                                        <a href="/site/admin/delete_hospital.php?id=<?php echo $hospital['hospital_id']; ?>" class="btn-action text-red-300 hover:text-red-100" onclick="return confirm('مطمئن هستید که می‌خواهید این بیمارستان را حذف کنید؟');"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            <?php if (empty($hospitals)): ?>
                                <tr>
                                    <td colspan="5" class="text-center py-4">بیمارستانی یافت نشد!</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
